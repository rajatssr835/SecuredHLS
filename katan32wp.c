...
void encryptdom ( u64 plain,u64 plain1, ap_int<13>  *cipher, ap_int<13>  *cipher1, u80 key, u80 key1, _Bool *f_reg0, _Bool *f0_reg0,  _Bool *f_reg1,  _Bool *f0_reg1) {
 _Bool *i1,  *i2,  *i12,  *i22,  *i13,  *i23,  *i14,  *i24,  *y1,  *y2,  *y12,  *y22,  *y13,  *y23,  *y14,  *y24;
...
#pragma HLS_interface y1 none_registered
#pragma HLS_interface y2 none_registered
#pragma HLS_interface y12 none_registered
#pragma HLS_interface y22 none_registered
#pragma HLS_interface y13 none_registered
#pragma HLS_interface y23 none_registered
#pragma HLS_interface y14 none_registered
#pragma HLS_interface y24 none_registered
...
//#pragma  array_map variable=L2 instance=L2_temp horizontal
  ...
  ap_int<100> k1, k2; ap_int<4> f;ap_int<2> temp_var;ap_int<32> L_temp;
  int i,j; 
  ...
  *f0_reg0 = L11[X1_32] ^ L11[X2_32] ^ tempy1 ^ tempy12     ^ k1[i];
  *f1_reg0 = L12[X1_32] ^ L12[X2_32] ^ tempy2 ^ tempy22 ;
  ...
  *f0_reg1 = L21[Y1_32] ^ L21[Y2_32] ^  tempy13 ^ tempy14     ^ k2[i];
  *f1_reg1 = L22[Y1_32] ^ L22[Y2_32] ^ tempy23 ^ tempy24 ;
